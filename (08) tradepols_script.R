...
setwd("/Users/brandonharrington/Desktop/Journal Article/Data/GITHUB")
...
IDN_net_plot_SR <- plot(irf_IDN_VAR_diff, main="Indonesia", ylab="", sub="months post politcal shock", ylim=c(-0.04,0.04), cex=2.5, cex.axis = 2, cex.lab=2.5)
mtext("change in exports/100 (%)", side = 2, line = 3.5, cex = 2.5)
MYS_net_plot_SR <- plot(irf_MYS_VAR_diff, main="Malaysia", xlab="", ylab="", sub="months post politcal shock", ylim=c(-0.04,0.04), cex=2.5, cex.axis = 2, cex.lab=2.5)
mtext("change in exports/100 (%)", side = 2, line = 3.5, cex = 2.5)
PHL_net_plot_SR <- plot(irf_PHL_VAR_diff, main="Philippines", xlab="", ylab="", sub="months post politcal shock", ylim=c(-0.04,0.04), cex=2.5, cex.axis = 2, cex.lab=2.5)
mtext("change in exports/100 (%)", side = 2, line = 3.5, cex = 2.5)
SGP_net_plot_SR <- plot(irf_SGP_VAR_diff, main="Singapore", xlab="", ylab="", sub="months post politcal shock", ylim=c(-0.04,0.04), cex=2.5, cex.axis = 2, cex.lab=2.5)
mtext("change in exports/100 (%)", side = 2, line = 3.5, cex = 2.5)
THA_net_plot_SR <- plot(irf_THA_VAR_diff, main="Thailand", xlab="", ylab="", sub="months post politcal shock", ylim=c(-0.04,0.04), cex=2.5, cex.axis = 2, cex.lab=2.5)
mtext("change in exports/100 (%)", side = 2, line = 3.5, cex = 2.5)
VNM_net_plot_SR <- plot(irf_VNM_VAR_diff, main="Vietnam", xlab="", ylab="", sub="months post politcal shock", ylim=c(-0.04,0.04), cex=2.5, cex.axis = 2, cex.lab=2.5)
mtext("change in exports/100 (%)", side = 2, line = 3.5, cex = 2.5)
